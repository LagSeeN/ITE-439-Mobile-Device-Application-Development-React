...
const HomeScreen = ({navigation}) => {
  ...
  //     txn.executeSql(
  //       "SELECT name FROM sqllite_master WHERE type='table' AND name='table_user'",
  //       [],
  //       function (res) {
  ...
  //         }
  //         txn.executeSql(
  //           'CREATE TABLE IF NOT EXISTS table_user(user_id INTEGER PRIMARY KEY AUTOINCREMENT, user_name VARCHAR(20), user_contact INT(10), user_address VARCHAR(25))',
  //           [],
  //         );
  //       },
  //     );
